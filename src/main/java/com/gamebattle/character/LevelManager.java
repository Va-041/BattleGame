...
import com.gamebattle.gameLogic.BattleSystem;
...
public class LevelManager {
    ...
    // можно ли повысить выбранный класс
    private static boolean canLevelUpClass(Character character, CharacterClass chosenClass) {
        ...
        // Если класс новый - есть ли место для нового класса
        if (existingClass == null) {
            return getTotalClassLevels(character) < 3;
        }

        // Если класс существует - не достиг ли он максимального уровня и есть ли свободные уровни
            ...
            try {
                ...
                if (!canLevelUpClass(character, chosenClass)) {
                    ...
                    if (existingClass != null && existingClass.getLevel() >= 3) {
                        ...
                        System.out.print("Достигнут максимальный суммарный уровень (3). Невозможно добавить новые " +
                                "уровни. Выберите другой класс: ");
                    }
                    continue;
                }
